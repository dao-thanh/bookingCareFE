                 ...
                 <div className='doctor-schedule-container'>
                    ...
                    <div className='all-available-time'>
                        <div className='text-calendar'>
                            <span><i className="fas fa-calendar-alt"> <FormattedMessage id="patient.detail-doctor.schedule"/></i></span>
                        </div>
                            ...
                            {   
                                ...
                                <>
                                        ...
                                        <div className='book-free'>
                                            <span><FormattedMessage id="patient.detail-doctor.choose"/> <i className='far fa-hand-point-up'></i>
