const actionTypes = Object.freeze({
    ...
    FETCH_TOP_DOCKERS_FAILED: 'FETCH_TOP_DOCKERS_FAILED',

    FETCH_ALL_DOCTORS_SUCCESS: 'FETCH_ALL_DOCTORS_SUCCESS',
    FETCH_ALL_DOCKERS_FAILED: 'FETCH_ALL_DOCKERS_FAILED',

    
    SAVE_DETAIL_DOCTORS_SUCCESS: 'SAVE_DETAIL_DOCTORS_SUCCESS',
    SAVE_DETAIL_DOCKERS_FAILED: 'SAVE_DETAIL_DOCKERS_FAILED',

    FETCH_DETAIL_DOCTOR_SUCCESS: 'FETCH_DETAIL_DOCTOR_SUCCESS',
    FETCH_DETAIL_DOCKER_FAILED: 'FETCH_DETAIL_DOCKER_FAILED',
